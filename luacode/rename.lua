...
Options after ?:
    ...
    if not dest then
      return "Cannot get destination, FROM>TO needed."
    end
	...
	return "Destination '"..dest.."' is not a folder. Cannot "..myname.." with wildcard source."
    end
	...
	if dstisdir then
	  dest = destdir.."/"..file
        ...
        if not dryrun then
          ...
          if not ok then
            io.stderr:write("Could not "..myname.." file: '"..source.."' to '"..dest.."'\n")
          elseif not quiet then  
            out = out..myname:gsub("^%l", string.upper).."d file: '"..source.."' to '"..dest.."'\n"
          end
        elseif not quiet then
          out = out.."Not "..myname.."ed file: '"..source.."' to '"..dest.."'\n"
        end
      end
    end
  end
