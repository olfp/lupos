...
const char *CKeyMap::s_KeyStrings[KeyMaxCode-KeySpace][2] =
{
	#include "keymap_esc.h"
};
...
const char *CKeyMap::GetString (u16 nKeyCode, u8 nModifiers, char Buffer[2]) const
{
	...
	{
	  u8 cmap = (nModifiers & (KEY_LCTRL_MASK | KEY_RCTRL_MASK)) ? 1 : 0;
	  return s_KeyStrings[nKeyCode-KeySpace][cmap];
	}
